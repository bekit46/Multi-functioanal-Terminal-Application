    ...
    public static void main(String args[])
    {
        ...
        while(true)
        {
            ...
            switch(input)
            {
                ...
                case "E":
                    clearConsole();
                    art("see you soon",false,scanner);
                    scanner.close();
                    return;
                default:
                    clearConsole();
...
//************************************OPTION A ALL FUNCTIONS****************************************************
    ...
    public static void FunctionA(Scanner scanner)
    {
        ...
        if(geometric_mean(array_size, user_array)!=-1)
            System.out.printf("Geometric mean: %.4f\n" , geometric_mean(array_size, user_array));
        else
            System.out.println("Geometric mean: Array includes non positive numbers, geometric mean cannot be calculated.");
        
        if(harmonic_mean(array_size, user_array, 0, 0) != -1)
            System.out.printf("Harmonic mean:  %.4f\n" , harmonic_mean(array_size, user_array, 0, 0));
        else
            System.out.println("Harmonic mean:  Array inludes non positive numbers, harmonic mean cannot be calculated.");
            ...
            if (gameWon) {
                ...
                if(currentPlayer=='X'){
                    System.out.print(           "       _                         ____             _           \n" + 
                                                ...
                                                "| '_ \\| |/ _` | | | |/ _ \\ '__|   __) | \\ \\ /\\ / / | '_ \\/ __|\n" + 
                                                "| |_) | | (_| | |_| |  __/ |     / __/   \\ V  V /| | | | \\__ \\    (on the move "+counter+")\n" + 
                    ...
                    System.out.print(           "       _                         _            _           \n" + 
                                                ...
                                                "| '_ \\| |/ _` | | | |/ _ \\ '__| | | \\ \\ /\\ / / | '_ \\/ __|\n" + 
                                                "| |_) | | (_| | |_| |  __/ |    | |  \\ V  V /| | | | \\__ \\    (on the move "+counter+")\n" + 
...
//************************************EXTRA FUNCTIONS****************************************************
     ...
     *                with group members names opening animation (true) or terminating animation (false).
    ...
    public static void art(String input,boolean opening,Scanner scanner){
        ...
        /* without animation, for all other word prints. No usage for this project
